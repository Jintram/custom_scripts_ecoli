...
std_data_frames = [data_frames data_frames(end:-1:1)]; % DJK 090319 was data_frames
std_data_std = [data_field_mean-sqrt(data_field_variance) data_field_mean(end:-1:1)+sqrt(data_field_variance(end:-1:1))];
fill(std_data_frames,std_data_std,'r','EdgeColor',[0.8 0.8 0.8],'FaceColor',[0.8 0.8 0.8]);

% plot line
line( 'Xdata',data_frames, ... % DJK 090319 was data_frames
