...
% The standard version assumes that all Fluor Images have bin=2 (DOES NOT
% INQUIRE THE INFO OF THE IMAGE!).
% Here, it's assumed that ALL FLUO IMAGES HAVE BIN=1. (useful for high
% intensity beads)(NW2013-04-20)
