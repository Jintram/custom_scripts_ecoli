...
if useColor
  number_of_colors = 100;
   map = colorGray(number_of_colors); %blubb
 % map=zeros(100,3);
 % for i=1:50
 %     map(i,1)=1-i/50; map(i,2)=0.5-i/200; map(i,3)=0.5-i/200;
 %     map(101-i,3)=1-i/50;map(101-i,2)=0.5-i/200;map(101-i,1)=0.5-i/200;
 % end
...
if useColor
  ...
  for k=1:30 %60:size(map,1) %blubb
