...
h42_pos1 = scatter(plotx_37_pos1, ploty_37_pos1, 100,colorAmolfBlue,'o','LineWidth',2); % WT, 37C
...
plot(mybins, score_37_pos1,'--o','LineWidth',3,'color',colorAmolfBlue); % WT, 37C
