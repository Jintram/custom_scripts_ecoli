...
%% Parameter settings
STOREDANALYSISFILENAME = '14-Sep-2015CompleteAnalyzedData_GFP.mat';

USERSETTINGS.myRootDir='U:\ZZ_EXPERIMENTAL_DATA\C_Platereader\';
USERSETTINGS.myDateDir='2015_09_10\';
USERSETTINGS.datafile='2015-09-10_extracellular_cAMP_withReporter.xls';
...
%% Get the stored data
load([USERSETTINGS.myRootDir USERSETTINGS.myDateDir STOREDANALYSISFILENAME])
...
if SIMPLIFIEDLEGEND
    legend(legendLinesHandles(3:4),{'control','\DeltacAMP cells'},'Location','northeastoutside'); 
    figure(88);
end
