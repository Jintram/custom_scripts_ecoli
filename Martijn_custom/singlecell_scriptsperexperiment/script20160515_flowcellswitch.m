...
SCRIPTNAME = 'script20160515_flowcellswitch.m';
...
if ~exist('FITWINDOWS', 'var')
    ...
    %FITWINDOWS = [0,SWITCHTIME; 250,600]; 
...
% save the figure 
saveas(h, [MYDIR 'summaryPlot_colonylength_twowindows.tif'],'tif');
saveas(h, [MYDIR 'summaryPlot_colonylength_twowindows.fig'],'fig'); %epsc
...
saveas(h, [MYDIR 'summaryPlot_colonylength_growthmean.tif'],'tif');
saveas(h, [MYDIR 'summaryPlot_colonylength_growthmean.fig'],'fig');
...
saveas(h, [MYDIR 'summaryPlot_colonylength_fluorsignal.tif'],'tif');
saveas(h, [MYDIR 'summaryPlot_colonylength_fluorsignal.fig'],'fig');
